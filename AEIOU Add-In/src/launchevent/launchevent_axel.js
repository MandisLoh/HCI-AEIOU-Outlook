...
function hasMatches(body) {
  ...
  const arrayOfTerms = ["send", "picture", "document", "attachment", "fruit"];
...
function getAttachmentsCallback(asyncResult) {
  ...
  if (asyncResult.value.length > 0) {
    ...
    event.completed({ allowEvent: false, errorMessage: "2Meeting detected, do you want to create a new appointment?" });
  } else {
    event.completed({ allowEvent: false, errorMessage: "1Meeting detected, do you want to create a new appointment?" });
  }
}
